    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", background: "#ffffff", color: "#111111", padding: "64px", fontFamily: "sans-serif" }}>
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ marginTop: 16, fontSize: 62, fontWeight: 800 }}>Insights</div>
          <div style={{ marginTop: 12, fontSize: 28 }}>Systems thinking, automation, and digital execution.</div>
        </div>
      </div>
    ),
    size,
