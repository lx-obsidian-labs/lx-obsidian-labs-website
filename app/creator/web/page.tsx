  ...
  return (
    <>
      <Section className="bg-white py-20">
        ...
        <h1 className="mt-3 text-3xl font-bold md:text-4xl">Web & App Builder IDE</h1>
        <p className="mt-4 max-w-2xl text-sm text-muted">Prompt-to-plan workspace with IDE-style artifact browsing, draft editing, and versioned outputs.</p>
      </Section>
